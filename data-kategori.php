                ...
                <table border="1" cellspacing="0" class="table table-striped table-bordered table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="edit-kategori.php?id=<?php echo $row['id_kategori'] ?>" class="btn btn-primary btn-sm">Edit</a> 
                                <a href="proses-hapus.php?idk=<?php echo $row['id_kategori'] ?>" class="btn btn-danger btn-sm" onclick="return confirm('Yakin ingin hapus ?')">Hapus</a>
                            </td>
                        </tr>
                    <?php }} else { ?>
                        <!-- jika data kategori tidak ada isi -->
                        <tr>
