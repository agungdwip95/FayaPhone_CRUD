<?php
     ...
     //jika tidak ada data arahkan ke data kategori (jika ada orang iseng hapus id di url)
            ...
            <h3>Edit Data Kategori</h3>
              <div class="box">
                <form action="" method="POST">
                    <div class="mb-3">
                        <input type="text" class="form-control border-dark" name="nama" placeholder="Nama Kategori" class="input-control" value="<?php echo $k->nama_kategori ?>" required>
                    </div>
